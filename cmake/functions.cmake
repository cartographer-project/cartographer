...
function(google_test NAME ARG_SRC)
  ...
  if (TARGET standalone_gmock_main)
    get_target_property(IIDIRS standalone_gmock_main INTERFACE_INCLUDE_DIRECTORIES)
    message("interface include dirs: ${IIDIRS}")
    get_target_property(IMPLOC standalone_gmock_main IMPORTED_LOCATION)
    message("imported location: ${IMPLOC}")
  else()
    message("ERROR: gmock main is undefined")
  endif()
