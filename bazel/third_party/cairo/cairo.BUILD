...
genrule(
    name = "config_h",
    srcs = ["@com_github_thirdwave_ai_cartographer//bazel/third_party/cairo:config.h"],
...
genrule(
    ...
    srcs = ["@com_github_thirdwave_ai_cartographer//bazel/third_party/cairo:cairo-features.h"],
