...
TEST(PointCloudTest, TransformPointCloud) {
  ...
  point_cloud.emplace_back(Eigen::Vector3f{0.5f, 0.5f, 1.f});
  point_cloud.emplace_back(Eigen::Vector3f{3.5f, 0.5f, 42.f});
...
TEST(PointCloudTest, TransformTimedPointCloud) {
  ...
  point_cloud.emplace_back(Eigen::Vector3f{0.5f, 0.5f, 1.f}, 0.f);
  point_cloud.emplace_back(Eigen::Vector3f{3.5f, 0.5f, 42.f}, 0.f);
