...
// Stores 3D positions of points with their relative measurement time in the fourth
...
// If timing is not available, all fourth entries are 0.f. For 2D points, the third
// entry is 0.f (and the fourth entry is time).
