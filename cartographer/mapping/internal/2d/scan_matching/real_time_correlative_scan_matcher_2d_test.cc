...
class RealTimeCorrelativeScanMatcherTest : public ::testing::Test {
 protected:
  RealTimeCorrelativeScanMatcherTest()
    ...
    point_cloud_.emplace_back(Eigen::Vector3f{0.025f, 0.175f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.025f, 0.175f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.075f, 0.175f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.125f, 0.175f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.125f, 0.125f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.125f, 0.075f, 0.f});
    point_cloud_.emplace_back(Eigen::Vector3f{-0.125f, 0.025f, 0.f});
