...
TEST(FastCorrelativeScanMatcherTest, CorrectPose) {
  ...
  point_cloud.emplace_back(Eigen::Vector3f{-2.5f, 0.5f, 0.f});
  point_cloud.emplace_back(Eigen::Vector3f{-2.f, 0.5f, 0.f});
  point_cloud.emplace_back(Eigen::Vector3f{0.f, -0.5f, 0.f});
  point_cloud.emplace_back(Eigen::Vector3f{0.5f, -1.6f, 0.f});
  point_cloud.emplace_back(Eigen::Vector3f{2.5f, 0.5f, 0.f});
  point_cloud.emplace_back(Eigen::Vector3f{2.5f, 1.7f, 0.f});
...
TEST(FastCorrelativeScanMatcherTest, FullSubmapMatching) {
  ...
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{-2.5f, 0.5f, 0.f});
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{-2.25f, 0.5f, 0.f});
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{0.f, 0.5f, 0.f});
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{0.25f, 1.6f, 0.f});
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{2.5f, 0.5f, 0.f});
  unperturbed_point_cloud.emplace_back(Eigen::Vector3f{2.f, 1.8f, 0.f});
