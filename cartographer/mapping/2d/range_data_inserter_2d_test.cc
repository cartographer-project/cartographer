...
class RangeDataInserterTest2D : public ::testing::Test {
 protected:
  ...
  void InsertPointCloud() {
    ...
    range_data.returns.emplace_back(Eigen::Vector3f{-3.5f, 0.5f, 0.f});
    range_data.returns.emplace_back(Eigen::Vector3f{-2.5f, 1.5f, 0.f});
    range_data.returns.emplace_back(Eigen::Vector3f{-1.5f, 2.5f, 0.f});
    range_data.returns.emplace_back(Eigen::Vector3f{-0.5f, 3.5f, 0.f});
