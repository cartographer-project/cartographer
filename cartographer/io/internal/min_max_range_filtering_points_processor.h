...
#ifndef CARTOGRAPHER_IO_INTERNAL_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
#define CARTOGRAPHER_IO_INTERNAL_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
...
#endif  // CARTOGRAPHER_IO_INTERNAL_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
