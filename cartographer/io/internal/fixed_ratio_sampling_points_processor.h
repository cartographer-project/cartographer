...
#ifndef CARTOGRAPHER_IO_INTERNAL_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
#define CARTOGRAPHER_IO_INTERNAL_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
...
#endif  // CARTOGRAPHER_IO_INTERNAL_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
