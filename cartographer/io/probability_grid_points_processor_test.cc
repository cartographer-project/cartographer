...
std::unique_ptr<PointsBatch> CreatePointsBatch() {
  ...
  points_batch->points.emplace_back(Eigen::Vector3f{0.0f, 0.0f, 0.0f});
  points_batch->points.emplace_back(Eigen::Vector3f{0.0f, 1.0f, 2.0f});
  points_batch->points.emplace_back(Eigen::Vector3f{1.0f, 2.0f, 4.0f});
  points_batch->points.emplace_back(Eigen::Vector3f{0.0f, 3.0f, 5.0f});
  points_batch->points.emplace_back(Eigen::Vector3f{3.0f, 0.0f, 6.0f});
  return points_batch;
}
