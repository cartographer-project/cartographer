...
class TrajectoryBuilderStub
 ...
 private:
  ...
  ClientWriter<proto::AddRangefinderDataRequest> rangefinder_writer_;
  ClientWriter<proto::AddImuDataRequest> imu_writer_;
  ClientWriter<proto::AddOdometryDataRequest> odometry_writer_;
  ClientWriter<proto::AddFixedFramePoseDataRequest> fixed_frame_writer_;
